...
@Slf4j
@Service
public class TelegramService extends TelegramBotsApi {
    private final StatedApiService statedApiService;
    private BotSession botSession = null;

    public TelegramService(Bot bot, ConfigurationDispatcher configurationDispatcher, StatedApiService statedApiService) throws TelegramApiException {
    ...
    private void initialization(Bot bot){
        try{
