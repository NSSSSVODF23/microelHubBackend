...
public class TelegramService extends TelegramLongPollingBot implements MessageSenderWrapper {
    ...
    public TelegramService(@Lazy MessageAggregatorService messageAggregatorService, ConfigurationDispatcher configurationDispatcher, AttachmentsSavingController attachmentsSavingController) {
